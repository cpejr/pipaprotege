...
function Cap_perg9({
  ...
  const handleSave = () => {
    ...
    if (!trimmed) return alert("Por favor, digite uma resposta antes de salvar!");
    if (!/^p/i.test(trimmed)) return alert('A resposta deve começar com a letra "P"!');
    navigate("/capitulo2/14");
  };
