...
function Cap_perg5({
  question = "Tenho cinco dedos e gosto de segurar, sem mim fica difícil escrever ou desenhar. Quem sou eu?",
  initialPlaceholder = 'DIGITE AQUI A SUA RESPOSTA\nELA COMEÇA COM A LETRA "M"\nDEPOIS CLIQUE EM "OK" PARA SALVAR',
}) {
  ...
  const handleSave = () => {
    ...
    if (!/^m/i.test(trimmed)) {
      alert('A resposta deve começar com a letra "M"!');
      return;
    }
    navigate("/capitulo2/pergunta6");
  };
