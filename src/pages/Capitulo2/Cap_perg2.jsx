...
function Cap_perg2({
  question = "Seguro a cabeça sem reclamar, sou fino e comprido, gosto de me alongar. Quem sou eu?",
  initialPlaceholder = 'DIGITE AQUI A SUA RESPOSTA\nELA COMEÇA COM A LETRA "P"\nDEPOIS CLIQUE EM "OK" PARA SALVAR',
}) {
  ...
  const handleSave = () => {
    ...
    if (!/^p/i.test(trimmed)) {
      alert('A resposta deve começar com a letra "P"!');
      return;
    }
    navigate("/capitulo2/pergunta3");
  };
