...
import num1 from "./../../assets/Capitulo5Img/Perguntas/3.png";
import corpo from "./../../assets/Capitulo5Img/Perguntas/estranho.png";
import palavra from "./../../assets/Capitulo5Img/Perguntas/palavra3.png";
...
export default function C5_Tela_06() {
  const navigate = useNavigate();
  const nextPath = "/capitulo5/tela-07";
  ...
  const respostaCorreta = "ESTRANHO";
        ...
        {showOutroModal && (
          <ModalButton
            content={
              <>
                {" "}
                Não é legal quando alguém toca em você e te faz se sentir <strong>estranho</strong>,
                mesmo que ela diga que é brincadeira.
              </>
            }
            defaultOpen={true}
            showButton={false}
