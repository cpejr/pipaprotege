...
import num1 from "./../../assets/Capitulo5Img/Perguntas/8.png";
import corpo from "./../../assets/Capitulo5Img/Perguntas/triste.png";
import palavra from "./../../assets/Capitulo5Img/Perguntas/palavra8.png";
...
export default function C5_Tela_11() {
  const navigate = useNavigate();
  const nextPath = "/capitulo5/tela-12";
        ...
        {showOutroModal && (
          <ModalButton
            content={
              <>
                {" "}
                Não é legal quando alguém fala que você não é bacana só porque você não quis fazer
                algo que te deixa <strong>triste</strong> ou com medo.
              </>
            }
            defaultOpen={true}
            showButton={false}
