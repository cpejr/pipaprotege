...
import num1 from "./../../assets/Capitulo5Img/Perguntas/5.png";
import corpo from "./../../assets/Capitulo5Img/Perguntas/roupa.png";
import palavra from "./../../assets/Capitulo5Img/Perguntas/palavra5.png";
import { useNavigate } from "react-router-dom";
import InputModal from "../../components/common/Modal/InputModal";
import ModalButton from "../../components/common/Modal/ModalButton";
import { useState } from "react";

export default function C5_Tela_08() {
  const navigate = useNavigate();
  const nextPath = "/capitulo5/tela-09";
        ...
        {showOutroModal && (
          <ModalButton
            content={
              <>
                {" "}
                Não é legal quando alguém mostra foto ou vídeos de pessoas sem{" "}
                <strong>roupa</strong> para você.
              </>
            }
            defaultOpen={true}
            showButton={false}
