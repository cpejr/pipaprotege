...
import num1 from "./../../assets/Capitulo5Img/Perguntas/7.png";
import corpo from "./../../assets/Capitulo5Img/Perguntas/sozinho.png";
import palavra from "./../../assets/Capitulo5Img/Perguntas/palavra7.png";
import { useNavigate } from "react-router-dom";
import InputModal from "../../components/common/Modal/InputModal";
import ModalButton from "../../components/common/Modal/ModalButton";
import { useState } from "react";

export default function C5_Tela_10() {
  const navigate = useNavigate();
  const nextPath = "/capitulo5/tela-11";
        ...
        {showOutroModal && (
          <ModalButton
            content={
              <>
                {" "}
                Não é legal quando alguém pede para ficar <strong>sozinho</strong> com você, sem um
                adulto de confiança por perto.
              </>
            }
            defaultOpen={true}
            showButton={false}
