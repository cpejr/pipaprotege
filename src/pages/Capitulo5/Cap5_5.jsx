...
import num1 from "./../../assets/Capitulo5Img/Perguntas/2.png";
import corpo from "./../../assets/Capitulo5Img/Perguntas/medo.png";
import palavra from "./../../assets/Capitulo5Img/Perguntas/palavra2.png";
...
export default function C5_Tela_05() {
  const navigate = useNavigate();
  const nextPath = "/capitulo5/tela-06";
        ...
        {showOutroModal && (
          <ModalButton
            content={
              <>
                {" "}
                Não é legal quando alguém quer que você faça algo e isso faz você se sentir estranho
                ou com <strong>medo</strong>.
              </>
            }
            defaultOpen={true}
            showButton={false}
