...
import C2_Tela_17 from "../pages/Capitulo2/Pag2_17";
import C2_Tela_18 from "../pages/Capitulo2/Pag2_18";
import C2_Tela_19 from "../pages/Capitulo2/Pag2_19";
import C2_Tela_20 from "../pages/Capitulo2/Pag2_20";
import C2_Tela_21 from "../pages/Capitulo2/Pag2_21";
import C2_Tela_22 from "../pages/Capitulo2/Pag2_22";
...
const Capitulo2RoutesJSX = (
  <Route path='capitulo2'>
    ...
    <Route path='tela-14' element={<C2_Tela_14 />} />
    <Route path='tela-15' element={<C2_Tela_15 />} />
    <Route path='tela-16' element={<C2_Tela_16 />} />
    <Route path='tela-17' element={<C2_Tela_17 />} />
    <Route path='tela-18' element={<C2_Tela_18 />} />
    <Route path='tela-19' element={<C2_Tela_19 />} />
    <Route path='tela-20' element={<C2_Tela_20 />} />
    <Route path='tela-21' element={<C2_Tela_21 />} />
    <Route path='tela-22' element={<C2_Tela_22 />} />
